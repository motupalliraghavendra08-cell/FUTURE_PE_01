...
## Project Objective
To design a structured, reusable prompt engineering system that generates high-quality, conversion-focused website copy for local businesses.
...
- Structured business input variables (name, location, audience, USP)
